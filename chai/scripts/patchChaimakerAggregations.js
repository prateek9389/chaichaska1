...
const file = 'app/chaimaker/page.js';
...
// 8. Add subscriptions state back because it is needed for activeSubs derivation
if (!content.includes('const [subscriptions, setSubscriptions]')) {
...
// 9. Add getSubscriptions back to useEffect
if (!content.includes('getSubscriptions().then(setSubscriptions)')) {
  content = content.replace(
...
console.log('Chaimaker page patched with dynamic aggregators.');
